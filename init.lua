...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = { preset = 'super-tab' }, -- Tab to accept, fallback to indent
      appearance = { nerd_font_variant = 'mono' },
      completion = {
        documentation = { auto_show = false, auto_show_delay_ms = 500 },
        trigger = { show_in_snippet = false }, -- avoid popup while jumping snippets
      },
      sources = {
  ...
  },
  {
    ...
    cmd = 'Neotree', -- lazy-load when the :Neotree command is run
    keys = {
    ...
    config = function()
      require('rose-pine').setup {
        ...
        groups = {
          ...
          NormalFloat = 'NONE', -- floating windows transparent
          FloatBorder = 'NONE',
        },
      }
      ...
      -- Optional: make SignColumn transparent
      vim.api.nvim_set_hl(0, 'SignColumn', { bg = 'NONE' })
    end,
  },
--]]
  {
    ...
    config = function()
      require('cyberdream').setup {
        ...
        bold = true, -- optional: enable bold text
        italic = false, -- optional: disable italics
        underline = true, -- optional: enable underline
...
-- Set .h files to cpp filetype for better LSP support
vim.api.nvim_create_autocmd({ 'BufRead', 'BufNewFile' }, {
  pattern = '*.h',
  callback = function()
    if vim.fn.search('#include.*<.*>', 'nw') > 0 then
      vim.bo.filetype = 'cpp'
    end
  end,
})
